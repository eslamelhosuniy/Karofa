...
from routes.schemes.nlp import PushRequest, SearchRequest, TaggedPushRequest, TaggedSearchRequest
...
@nlp_router.post("/index/push-tagged")
...
@nlp_router.post("/index/search-tagged")
...
@nlp_router.post("/index/answer-tagged")
